...
SECRET_KEY = 'vzx4o50ij&k4#w6r-l-5x)ng*h=+9_ad@wn($1gtavk4c6nh27'
...
#ALLOWED_HOSTS = []
ALLOWED_HOSTS = ["localhost", "52.15.187.124"] 
...
DATABASES = {
    'default': {
        ...
        'NAME': 'exam2_db', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
